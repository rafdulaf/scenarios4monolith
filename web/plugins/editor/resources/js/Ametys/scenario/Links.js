Ext.define('Ametys.scenario.Links', {
    ...
    _insertScenarioElementLinkCb: function(contentId, id, text, imageUrl, imageNum, imageSize, contentType, color)
    {
        ...
        tinyMCE.activeEditor.execCommand('mceInsertContent', false, "<a href='#'>" + (imageUrl ? "<img data-contenttype=\"" + contentType+ "\" data-color=\"" + color + "\" src=\"" + imageUrl.replace("LANG", Ametys.cms.language.LanguageDAO.getCurrentLanguage()) + "\"/>" : "") + (text || '') + "{$caret}</a>");
